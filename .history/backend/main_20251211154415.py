...
async def chat(req: ChatRequest, user=Depends(get_current_user)):
    ...
    # 4) mode-specific system prompt (REPLACE existing block with this)
    ...
    system_prompt = (
        ...
        "'Sources Used'\n"
        "List the exact document titles, chapters, topics and page numbers "
        "from the context that were relevant to the answer. "
        "If nothing matches clearly, write: 'No direct source found'.\n\n"
        f"Context:\n{context_str}"
    )
