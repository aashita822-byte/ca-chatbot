...
async def chat(req: ChatRequest, user=Depends(get_current_user)):
    ...
    if not is_ca:
        answer = (
            "This assistant is focused only on CA-related questions "
            "(CA Inter, CA Final, subjects like Accounts, Tax, Law, Audit, etc.).\n\n"
            "Your question doesn't look like a CA question. "
            "Please ask something related to CA exams or syllabus."
        )
